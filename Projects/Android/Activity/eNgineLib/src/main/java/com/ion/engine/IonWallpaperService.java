...
public class IonWallpaperService extends GLWallpaperService {
	private static String TAG = "IonWallpaperService";
	...
	protected IonRenderer createRenderer()
	{
		IonLib.Load();
		SetApkName();
		IonLib.SetLoadFromApk(true);
		
		IonRenderer renderer = new IonRenderer();			
		
		renderer.LoadPreference(this.getAssets(), getSharedPreferences("SharefPref", 0));
