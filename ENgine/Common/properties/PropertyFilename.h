...
#include "PropertyFilenameWidget.h"

#endif

class PropertyFilename : public PropertyBase
{
public:

#ifdef EDITOR
	PropertyFilenameWidget* widgets;
#endif

	virtual const char* GetFIletype() { return ""; };
...
class value_name##prop_cl : public PropertyFilename\
{\
public:\
	virtual const char* GetFIletype() { return res_type; };\
