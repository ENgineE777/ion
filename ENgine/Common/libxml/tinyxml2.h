...
*/
class DEF_EXPORT XMLText : public XMLNode
{
...
/** An XML Comment. */
class DEF_EXPORT XMLComment : public XMLNode
{
    friend class XMLDocument;
public:
    virtual XMLComment*	ToComment()					{
...
*/
class DEF_EXPORT XMLDeclaration : public XMLNode
{
    friend class XMLDocument;
public:
    virtual XMLDeclaration*	ToDeclaration()					{
...
*/
class DEF_EXPORT XMLUnknown : public XMLNode
{
    friend class XMLDocument;
public:
    virtual XMLUnknown*	ToUnknown()					{
...
*/
class DEF_EXPORT XMLElement : public XMLNode
{
    friend class XMLBase;
    friend class XMLDocument;
public:
...
*/
class DEF_EXPORT XMLDocument : public XMLNode
{
    friend class XMLElement;
public:
    /// constructor
...
*/
class DEF_EXPORT XMLConstHandle
{
public:
...
/**
	...
	@endverbatim
*/
class DEF_EXPORT XMLPrinter : public XMLVisitor
{
public:
